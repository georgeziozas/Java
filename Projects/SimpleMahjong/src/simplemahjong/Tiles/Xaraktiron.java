...
/**
 * @desc Xaraktiron class extending Tiles class.
 */
public class Xaraktiron extends Tiles
{
     ...
     */
    public Xaraktiron(String specificTypeOfTile, int[] position)
    {
        super(specificTypeOfTile, position); /* calls the constructor of the super method which in this case is Tiles constructor */
        this.generalTypeTile = getGeneralTypeTile();
    }

    /**
     * @return generalTyTile
     * @desc Gives the 'XARAKTIRON' value to this tiles.generalTypeTile.
     */
    public generalTypeTile getGeneralTypeTile() {
        return simplemahjong.Game.generalTypeTile.XARAKTIRON;
    }
    ...
    public boolean isValidTiles(Tiles end)
    {
        ...
        {
            if (this.getGeneralTypeTile().equals(end.getGeneralTypeTile()))  /* Checks if they are in the same general category */
            {
